package com.sti.crst.pushnotification.config;
...
public class FcmClient {
	...
	public void send(Map<String, String> data) throws InterruptedException, ExecutionException {
		...
		Message message = Message.builder().putAllData(data).setTopic("chuck")
				.setWebpushConfig(WebpushConfig.builder().putHeader("ttl", "300").setNotification(
						new WebpushNotification("Background Title (server)", "Background Body (server)", "mail2.png"))
						.build())
				.build();
